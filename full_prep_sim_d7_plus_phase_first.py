...
if __name__ == "__main__":
    ...
    num_rounds = 2500
    num_shots = 100000
    parent_dir = "logs_prep_d7_plus_phase_first_p"+str(p_CNOT).split('.')[1]
    print(f"full_prep_sim_d7_plus_phase_first.py writing to {parent_dir}/{input_value}.log", flush=True)
