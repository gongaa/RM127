...
if __name__ == "__main__":
    ...
    print(f"writing to logs_prep_d15_plus/{input_value}.log", flush=True)
    total_passed = 0
    num_rounds = 2000
    num_shots = 100000
    fault_locations = ""
    ...
    with open(f"logs_prep_d15_plus/{input_value}_faults.log", 'w') as f:
        f.write(fault_locations)
    with open(f"logs_prep_d15_plus/{input_value}_single_fault.pkl", 'wb') as f:
