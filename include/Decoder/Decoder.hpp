...
public:
    ...
    static void f_plus_avx(const double* LLR_fst, const double* LLR_snd, const int size, double* LLR_new);
    static void f_minus_avx(const double* LLR_fst, const double* LLR_snd, const int* bits, const int size, double* LLR_new);
