...
p_CNOT = 0.001
rec_type = "H"
num_batch_dict = {0.0005: 4000, 0.0008: 2000, 0.001: 1000, 0.002: 800, 0.003:48, 0.004:2}
...
def run_exp(factor, factor_single, factor_correction, p_CNOT, rec_type, index):
    ...
    # print(cmd, dest)
    process = subprocess.Popen(['sbatch', '--mem-per-cpu', '8000', '--time', '12:00:00', '--output', dest, '--wrap', cmd])
